...
\section{Shape Reconstruction Examples}\label{sec:reconstruction_examples}
...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{Normalized Uncertainty\label{fig:geographos_uncertainty}}{\input{tikz/geographos_uncertainty.tikz}}~
    \subcaptionbox{Volume Percent Error\label{fig:geographos_volume}}{\input{tikz/geographos_volume.tikz}}
...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{Normalized Uncertainty\label{fig:golevka_uncertainty}}{\input{tikz/golevka_uncertainty.tikz}}~
    \subcaptionbox{Volume Percent Error\label{fig:golevka_volume}}{\input{tikz/golevka_volume.tikz}}
...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{Normalized Uncertainty\label{fig:52760_uncertainty}}{\input{tikz/52760_uncertainty.tikz}}~
    \subcaptionbox{Volume Percent Error\label{fig:52760_volume}}{\input{tikz/52760_volume.tikz}}
