...
\end{figure}
We utilize the 3D Fast intersection functionality of \gls{cgal}~\cite{cgalproject2018}.
...
The two triangular faces of the visible side of the cube are selected for the isotropic remeshing operation as shown in~\cref{cube_original_mesh}.
...
\begin{figure}[htbp]
    ...
    \caption{Components of spacecraft trajectory\label{fig:castlia_explore_components}}
\end{figure}
