...
To prove~\cref{item:prop_psi_psd}, we first seek to show that \( \Psi(R_d) \) is a minimum by showing that the first derivative is zero at \( R_d \).
...
Next, the second derivative of \( \Psi \) is shown to be positive at \( R_d \). 
