...
\begin{center}
        ...
        keepaspectratio,
        activate=pagevisible,
        addresource=videos/52760_exploration.mp4,
        flashvars={source=videos/52760_exploration.mp4}
        ]{\includegraphics[trim={20cm 10cm 20cm 10cm},clip,keepaspectratio,width=0.5\textwidth,height=0.5\textheight]{figures/computational_geometry/dynamic_exploration/52760/partial_14998.jpg}}{VPlayer.swf}%
        \includemedia[
        keepaspectratio,
        activate=pagevisible,
        addresource=videos/52760_exploration_cam_weight.mp4,
        flashvars={source=videos/52760_exploration_cam_weight.mp4}
        ]{\includegraphics[trim={20cm 10cm 20cm 10cm},clip,keepaspectratio,width=0.5\textwidth,height=0.5\textheight]{figures/computational_geometry/dynamic_exploration/52760/partial_14998.jpg}}{VPlayer.swf}
\end{center}
\end{frame}
...
\begin{center}
        ...
        keepaspectratio,
        activate=pagevisible,
        addresource=videos/castalia_exploration.mp4,
        flashvars={source=videos/castalia_exploration.mp4}
        ]{\includegraphics[trim={20cm 10cm 20cm 10cm},clip,keepaspectratio,width=0.5\textwidth,height=\textheight]{figures/computational_geometry/dynamic_exploration/castalia/partial_14998.jpg}}{VPlayer.swf}%
        \includemedia[
        keepaspectratio,
        activate=pagevisible,
        addresource=videos/castalia_exploration_cam_weight.mp4,
        flashvars={source=videos/castalia_exploration_cam_weight.mp4}
        ]{\includegraphics[trim={20cm 10cm 20cm 10cm},clip,keepaspectratio,width=0.5\textwidth,height=\textheight]{figures/computational_geometry/dynamic_exploration/castalia/partial_14998.jpg}}{VPlayer.swf}
\end{center}
...
\begin{center}
        ...
        keepaspectratio,
        activate=pagevisible,
        addresource=videos/castalia_refinement.mp4,
        flashvars={source=videos/castalia_refinement.mp4}
        ]{\includegraphics[trim={20cm 10cm 20cm 10cm},clip,keepaspectratio,width=0.5\textwidth,height=\textheight]{figures/computational_geometry/dynamic_exploration/castalia/partial_14998.jpg}}{VPlayer.swf}%
        \includemedia[
        keepaspectratio,
        activate=pagevisible,
        addresource=videos/castalia_refinement_cam_weight.mp4,
        flashvars={source=videos/castalia_refinement_cam_weight.mp4}
        ]{\includegraphics[trim={20cm 10cm 20cm 10cm},clip,keepaspectratio,width=0.5\textwidth,height=\textheight]{figures/computational_geometry/dynamic_exploration/castalia/partial_14998.jpg}}{VPlayer.swf}
\end{center}
...
\begin{center}
        ...
        keepaspectratio,
        activate=pagevisible,
        addresource=videos/castalia_landing.mp4,
        flashvars={source=videos/castalia_landing.mp4}
        ]{\includegraphics[trim={20cm 10cm 20cm 10cm},clip,keepaspectratio,width=0.5\textwidth,height=\textheight]{figures/computational_geometry/dynamic_exploration/castalia/partial_14998.jpg}}{VPlayer.swf}%
        \includemedia[
        keepaspectratio,
        activate=pagevisible,
        addresource=videos/castalia_landing_cam.mp4,
        flashvars={source=videos/castalia_landing_cam.mp4}
        ]{\includegraphics[trim={20cm 10cm 20cm 10cm},clip,keepaspectratio,width=0.5\textwidth,height=\textheight]{figures/computational_geometry/dynamic_exploration/castalia/partial_14998.jpg}}{VPlayer.swf}
\end{center}
