...
Present a review of current methods used to generate an asteroid shape
...
\begin{itemize}
    ...
    \item Months of mapping and ground OD 
\end{itemize}
...
\begin{itemize}
    ...
    \item Talk about the one that is implemented inside VTK
\end{itemize}
