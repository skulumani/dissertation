...
% TODO Make these better using PGFplots
\begin{figure}[htbp]
    \centering
    \subcaptionbox{Attitude error vector \( e_R \) components\label{fig:eRcon}}{\includegraphics[width=\textwidth,height=0.1\textheight]{tikz/eR_noadapt.tikz}}

    \subcaptionbox{Configuration error \( \Psi \)\label{fig:Psi_con}}{\includegraphics[width=\textwidth,height=0.3\textwidth]{tikz/Psi_noadapt.tikz}}

    \subcaptionbox{Angle to each constraint \label{fig:con_angles_con}}{\includegraphics[width=\textwidth,height=0.3\textwidth]{tikz/ang_con_noadapt.tikz}}
    \caption{Attitud Stabilization without adaptive update\label{fig:con}}
\end{figure}
