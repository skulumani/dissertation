...
This controller assumes that there is no disturbances on the attitude dynamics, i.e.\ \( \Delta = 0 \) for
\begin{align*}
    J\dot{\Omega} + \hat{\Omega} J \Omega = u_m + \Delta.
\end{align*}
...
We use the control inputs defined in~\cref{eq:translational_control,eq:rotational_control} and substitute them into the dynamic equations of motion in~\cref{eq:translational_dynamics,eq:attitude_dynamics}.
...
% TODO Give examples of choosing controller gains
...
\begin{figure}[htbp]
    ...
    \centering
    \subcaptionbox{Planar view of landing trajectory\label{fig:true_landing_trajectory}}{\includegraphics[width=0.7\textwidth]{figures/2017_AAS_fall/traj_fig.pdf}}
    \subcaptionbox{Position of spacecraft in the inertial frame\label{fig:pos_components}}{\includegraphics[width=0.7\textwidth]{figures/2017_AAS_fall/pos_fig.pdf}}
