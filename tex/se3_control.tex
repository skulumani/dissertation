...
\begin{figure}[htbp]%
    \centering 
    \subcaptionbox{Attractive attitude error function \( A(R) \) in spherical coordinate representation.\label{fig:attract_error} }{\includegraphics[trim={8mm 2mm 8mm 2mm}, clip, width=0.5\textwidth]{figures/2016_IJCAS/attract_error.pdf}}~
    \subcaptionbox{Repulsive attitude error function \( B(R) \) spherical coordinate representation.\label{fig:avoid_error} }{\includegraphics[trim={8mm 2mm 8mm 2mm}, clip, width=0.5\textwidth]{figures/2016_IJCAS/avoid_error.pdf}}

    \subcaptionbox{Combined attitude error function \( \Psi \) composed as the product of \( A(R) \) and \( B(R) \).\label{fig:combined_error} }{\includegraphics[trim={8mm 2mm 8mm 2mm}, clip, width=0.5\textwidth]{figures/2016_IJCAS/combined_error.pdf}}%
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.14\textwidth]{tikz/eR_noadapt.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.43\textwidth]{tikz/Psi_noadapt.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.43\textwidth]{tikz/ang_con_noadapt.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.43\textwidth]{tikz/Psi_adapt.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.14\textwidth]{tikz/dist_adapt.tikz}
