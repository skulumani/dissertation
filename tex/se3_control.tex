...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.43\textwidth]{tikz/Psi_timevarying.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.43\textwidth]{tikz/ang_con_timevarying.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.14\textwidth]{tikz/dist_timevarying.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.2\textwidth]{tikz/eR_exp.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.43\textwidth]{tikz/Psi_exp.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.14\textwidth]{tikz/eR_exp.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth,height=0.43\textwidth]{tikz/ang_con_exp.tikz}
