...
\begin{align} 
    \delta V &= -\sum_{i=1}^2  \bracket{m_i \parenth{R_A \deriv{U}{\vc{z}_i} }^T \delta \vb{x} + m_i \vc{\eta}^T \hat{\vc{\rho}_i} R^T R_A \deriv{U}{\vc{z}_i}}, \label{eq:dumbbell_kinetic_energy_variation} \\
...
\end{align}
Substituting~\cref{eq:dumbbell_potential_energy_variation,eq:dumbbell_kinetic_energy_variation} into~\cref{eq:hamiltons_principle}  gives
\begin{align}\label{eq:action_integral_full}
    \delta \mathcal{G} = \int_{t_0}^{t_f}& \left\{  \parenth{m_1 + m_2} \dot{\vc{x}}^T \delta \dot{\vc{x}} + \frac{1}{2} \tr{- \dot{\vc{\eta}} \parenth{J \vc{\Omega}}^\wedge + \vc{\eta} \parenth{\vh{\Omega} J \vc{\Omega}} } \right. \nonumber \\
                                         & \left. +\sum_{i=1}^2  \bracket{m_i \parenth{R_A \deriv{U}{\vc{z}_i} }^T \delta \vb{x} - m_i \vc{\eta}^T \hat{\vc{\rho}_i} R^T R_A \deriv{U}{\vc{z}_i}} \right\} dt.
\end{align}
...
\begin{align}
    \delta \mathcal{G} = \int_{t_0}^{t_f}& \left\{  \parenth{m_1 + m_2} \dot{\vc{x}}^T \delta \dot{\vc{x}} + \frac{1}{2} \tr{- \dot{\vc{\eta}} \parenth{J \vc{\Omega}}^\wedge + \vc{\eta} \parenth{\vh{\Omega} J \vc{\Omega}} } \right. \nonumber \\
                                         & \left. +\sum_{i=1}^2  \bracket{m_i \parenth{R_A \deriv{U}{\vc{z}_i} }^T \delta \vb{x} - m_i \vh{\eta}^T \hat{\vc{\rho}_i} R^T R_A \deriv{U}{\vc{z}_i}} \right\} dt.
\end{align}
