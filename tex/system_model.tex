...
Here we present the ellipsoid and polyhedron potential models.

\subsection{Constant Density Ellipsoid}\label{sec:constant_density_ellipsoid}

% TODO Write equations for constant density elliipsoid
% TODO Cite some works with use this model
