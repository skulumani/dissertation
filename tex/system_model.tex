...
\begin{itemize}
    \item \( \gls{rx} = R_A^T \vc{x}_1\) - the position of the center of mass of the dumbbell with respect to the asteroid and expressed in the asteroid fixed frame.
    \item \( \gls{rR} = R_A^T R_1\) - the orientation of the dumbbell with respect to the asteroid fixed frame. 
    This rotation matrix transforms a vector in the dumbbell fixed frame to the asteroid fixed frame.
    \item \( \gls{rv} = R_A^T \dot{\vecbf{x}}_1 \) - the velocity of the dumbbell center of mass with respect to the inertial frame represented in the asteroid fixed frame
    \item \( \gls{rW} = \vb{R} \vecbf{\Omega}_1\) - the angular velocity of the dumbbell with respect to the inertial frame represented in the asteroid fixed frame.
\end{itemize}
