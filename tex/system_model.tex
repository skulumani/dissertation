...
The dynamic equations of motion are crucial for the low energy orbit transfers in~\cref{sec:lowthrust_transfers}, the geometric controller design of~\cref{sec:se3_control}, and the shape reconstruction scheme of~\cref{sec:shape_reconstruction}.
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{tikz/ref_frames.tikz}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{tikz/dumbbell.tikz}
    \caption{Dumbbell Model of Rigid Spacecraft}
\end{figure}
...
\begin{figure}[h]
    ...
    \subcaptionbox{The neighborhood around this point is not homeomorphic to a disk\label{fig:knotted_polyhedron}}{\includegraphics[width=.33\textwidth]{figures/computational_geometry/pinched.png}}~
