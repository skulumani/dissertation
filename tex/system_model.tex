...
\begin{align} 
    \delta V &= -\sum_{i=1}^2  \bracket{m_i \parenth{R_A \deriv{U}{\vc{z}_i} }^T \delta \vb{x} + m_i \vh{\eta}^T \hat{\vc{\rho}_i} R^T R_A \deriv{U}{\vc{z}_i}}, \label{eq:dumbbell_kinetic_energy_variation} \\
...
\begin{subequations}\label{eq:action_integral_integration_by_parts}
    \begin{align}
        \int_{t_0}^{t_f} \braces{ \parenth{m_1 + m_2 } \dot{\vc{x}}^T \delta \dot{\vc{x}} } dt  = 
    \end{align}
\end{subequations}     
