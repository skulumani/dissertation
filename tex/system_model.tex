...
We additionally present some of the implementation details in our model and the adaptions for use with the \texttt{Surface_mesh} data structure presented  in~\cref{sec:polyhedron_data_structures}.
