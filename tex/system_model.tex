...
Furthermore, the model is defined in terms of continuous integral which must be numerically evaluated using methods of Carlson's elliptic integrals.

% TODO Drawbacks of the ellipsoid model
% Doesn't match the true shape
% Useful for analytical computations ( citations)
% Can't modify the model easily once a new shape is determined
% need to compute Carlson's elliptic integrals numerically
