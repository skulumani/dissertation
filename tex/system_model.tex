...
\end{itemize}
This constraint automatically ensures that all edges and vertices intersect properly.
...
The notion of equivalence is mathematically captured using the property of \gls{homeomorphism}.
...
This constraint will exclude objects that are not proper polyhedrons, for example those shown in~\cref{fig:improper_polyhedrons}.
