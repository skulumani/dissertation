...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{example-image-golden}
    \caption{Face based data structure~\label{fig:face_based_data_structure}}
\end{figure}
...
While conceptually simple and relatively straight
\begin{itemize}
    \item Tasks required to utilize the shape model
    \item Face vs. edge based data structure
    \item Discuss drawbacks of the OBJ format
    \item Summary and intro to halfedge data structure
    \item Good pictures
\end{itemize}
