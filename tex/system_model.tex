...
\begin{itemize}
    \item \( \vc{\mathsf{x}} = R_A^T \vc{x}_1\) - the position of the center of mass of the dumbbell with respect to the asteroid and expressed in the asteroid fixed frame.
    \item \( \mathsf{R} = R_A^T R_1\) - the orientation of the dumbbell with respect to the asteroid fixed frame. 
