...
\begin{align}
    T &= \frac{1}{2} \parenth{m_1 + m_2} \norm{\gls{sym:iv}}^2 + \frac{1}{2} \tr{\hat{\gls{sym:iW}} J_d \hat{\glsentrytext{sym:iW}}^T}, \nonumber\\
      &= \frac{1}{2} \parenth{m_1 + m_2} \parenth{\gls{sym:rv} R_A^T R_A \gls{sym:rv}} + \frac{1}{2} \tr{\parenth{\gls{sym:rR}^T \vc{\Omega}}^\wedge J_d \parenth{\vb{R}^TS(\vb{\Omega})\vb{R}}^T}, \nonumber\\
