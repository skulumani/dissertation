...
The configuration space for the rigid body motion of the spacecraft is the semi-direct product, \(\SE = \R^3 \times \SO \), namely the special euclidean group.
The special euclidean group is the group of all transformation
