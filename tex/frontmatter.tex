...
% glossary  terms
\loadglsentries{\string~/texmf/tex/latex/local/glossaries_terms.tex}
% abbreviations
\loadglsentries{\string~/texmf/tex/latex/local/glossaries_abbreviations.tex}
% symbols
\loadglsentries{\string~/texmf/tex/latex/local/glossaries_symbols.tex}
% Some abstract text
\abstract{
    Abstract
}
