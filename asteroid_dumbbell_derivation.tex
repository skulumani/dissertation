...
\date{03 February 2017}                         % Activate to display a given date or no date
...
\end{align}
Combining this with the kinematic equations of motion, \( \dot{R} = R S(\vecbf{\Omega}) \), and noticing the fact that
\begin{align}
    \int_{\mathsf{B}} \vecbf{\rho} \, dm = 0
\end{align}
the kinetic energy is reduced to
\begin{align}
